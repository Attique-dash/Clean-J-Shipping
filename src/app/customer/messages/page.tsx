        ...
        <header className="relative overflow-hidden rounded-3xl border border-white/50 admin-header p-6 text-white shadow-2xl mb-8">
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input
                className="w-64 pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl focus:border-[#0f4d8a] focus:ring-2 focus:ring-blue-100 focus:outline-none text-sm text-gray-900 placeholder:text-gray-400 font-normal bg-white shadow-sm"
