    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4" onClick={onClose}>
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto" onClick={e=>e.stopPropagation()}>
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-200 bg-gray-50">
          <button onClick={()=>{navigator.clipboard?.writeText(`Invoice for ${awb}: $${due.toFixed(2)}`); toast.success("Copied invoice details");}} className="flex items-center gap-2 px-4 py-2 border-2 border-[#0f4d8a] text-[#0f4d8a] rounded-lg hover:bg-blue-50 text-sm font-semibold"><Mail className="h-4 w-4"/>EMAIL INVOICE</button>
